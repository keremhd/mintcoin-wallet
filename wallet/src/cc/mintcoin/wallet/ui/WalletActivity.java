...
import cc.mintcoin.wallet.util.Crypto;
import cc.mintcoin.wallet.util.HttpGetThread;
import cc.mintcoin.wallet.util.Iso8601Format;
...
//		passwordView.addTextChangedListener(dialogButtonEnabler);
	...
	private void mailPrivateKeys(@Nonnull final File file)
	{
		...
		intent.setType("x-mintcoin/private-keys");
